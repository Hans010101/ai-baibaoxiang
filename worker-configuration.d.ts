/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.editor.jsonc --path worker-configuration.d.ts` (hash: b528b9715edb1d9d5a3e3cee4568bd5b)
// Runtime types generated with workerd@1.20260515.1 2026-08-28
interface __BaseEnv_Env {
	ADVISOR_RATE_LIMITER: RateLimit;
	AI: Ai;
	EDITORIAL_TOKEN_SHA256: "ee55871c0f274c596048e19a1258693637d1716f0f2588edbb11f1370d4faeb8";
	EDITORIAL_API_TOKEN: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/editor");
	}
