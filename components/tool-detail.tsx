    ...
    <main lang={en ? 'en' : 'zh-CN'}>
        ...
        '@graph': [
          {
            ...
            inLanguage: en ? 'en' : 'zh-CN', ...(verified ? { dateModified: item.verifiedAt } : {}), isPartOf: { '@id': `${origin}/#website` },
          ...
          },
          {
            ...
            operatingSystem: 'Web', keywords: tags.join(', '),
            ...(verified ? { isAccessibleForFree: item.free } : {}),
            ...(verified && item.free ? { offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } : {}),
          },
          {
      ...
      <div className="detail-wrap">
        ...
        <section className="detail-hero">
          <ToolLogo {...item} className="detail-icon" />
        ...
        <div className="detail-layout">
          <article className="detail-content">
            {!verified && <aside className="evidence-notice"><b>{en ? 'Pending verification' : '待验证记录'}</b><span>{en ? 'This record is discoverable for research, but its availability and access terms have not been independently verified. Confirm details with the linked official source.' : '这条记录可用于检索参考，但可用性与接入条件尚未完成独立核验，请以链接中的官方资料为准。'}</span></aside>}
