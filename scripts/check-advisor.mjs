...
import { localAdvisorPlan, rankAdvisorCandidates, shouldUseAdvisor } from '../lib/advisor.ts';
...
assert.equal(shouldUseAdvisor('Weather API', tools.map(({ name }) => name)), false);
assert.equal(shouldUseAdvisor('我想给旅行产品加入天气提醒，应该怎么做？'), true);
